...
def train(tparams: TrainerParams, mparams: ModuleParams):
    ...
    inputs= {'qv': torch.tensor([1.8697e-05], dtype=torch.float64), 'qr': torch.tensor([2.9856e-11], dtype=torch.float64), 'qc': torch.tensor([2.6203e-06], dtype=torch.float64), 'qi': torch.tensor([1.4042e-08], dtype=torch.float64), 'ni': torch.tensor([30.7754], dtype=torch.float64), 'nr': torch.tensor([0.0401], dtype=torch.float64), 'qs': torch.tensor([9.6269e-07], dtype=torch.float64), 'qg': torch.tensor([0.], dtype=torch.float64), 'temp': torch.tensor([2.1243], dtype=torch.float64), 'press': torch.tensor([332.4331], dtype=torch.float64), 'output': torch.tensor([2.2806e-11], dtype=torch.float64), 'dt': torch.tensor([120.0000], dtype=torch.float64), 't': torch.tensor([0.], dtype=torch.float64), 'lat': torch.tensor([9.], dtype=torch.float64), 'lon': torch.tensor([58.], dtype=torch.float64)}

    scripted_module = torch.jit.load("model.pt")
    output = scripted_module(inputs)
    print (output.detach())
